...
from source.models import DogImg
from source.tasks import get_random_breed_img, get_post_by_id, insert_dog, compare_result_fc_get_post
...
class TestDB:
    ...
    async def test_async_db(self, event_loop, async_session, breed: str, img: str):
        with allure.step("Insert dog img in PostgresSQL"):
